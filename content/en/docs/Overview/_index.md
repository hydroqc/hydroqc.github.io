...
### [hydroqc-ha - Home Assistant Custom Integration](https://github.com/hydroqc/hydroqc-ha) {{< badge >}}Recommended{{< /badge >}}
...
### [Home-Assistant addon](https://gitlab.com/hydroqc/hydroqc-hass-addons) {{< badge color="warning" >}}Legacy{{< /badge >}}
