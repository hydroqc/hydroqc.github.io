...
In the context of winter credits, a period is a time slot during which a specific rate or algorithmic logic is applied by Hydro-Québec.
...
Any period that is not a peak period.
