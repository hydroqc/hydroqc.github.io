...
##### During the peak
 ...
 Reduce the thermostat setpoint and avoid using power hungry appliances (electric oven, kettle, hot water heater, electric vehicle charger, etc)
...
graph TD
  ...
  PeakLowCon --> PeakEnd
  PeakEnd[Peak end<br/>10AM or 8PM] --> NormalEnd[Normal consumption]
...
graph TD
       ...
       AnchorStart[Anchor start<br/>1AM or 12PM] -->AnchorCritical{Critical?}

       AnchorCritical -->|Yes| AnchorHighCon[Raise consumption]
       PeakLowCon --> PeakEnd
       AnchorHighCon --> AnchorEnd
       PeakEnd[Peak end<br/>10AM or 8PM] --> Normal
...
graph TD
       ...
       AnchorStart[Anchor<br/>1AM or 12PM] -->AnchorCritical{Critical?}
